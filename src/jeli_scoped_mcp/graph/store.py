    ...
    async def search_by_entity(
        ...
        rows = await db.fetchall(
            ...
            SELECT DISTINCT m.id, m.content, m.trust_score, m.memory_type,
                   ...
                   m.embedded_at, m.valid_from, m.session_id,
                   m.provenance_ref, m.amended_from, m.canonical_version,
        ...
        return [
            {
                ...
                "amended_from": r.get("amended_from"),
                "canonical_version": r.get("canonical_version", 1),
